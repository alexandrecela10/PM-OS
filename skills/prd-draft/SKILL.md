...
**What you get:** A 1-2 page modern PRD with hypothesis, strategic fit, non-goals, success metrics, rollout plan, and optional behavior examples. Saved to `outputs/prds/[feature-name-kebab-case]-[stage].md`. Based on `{pm-os}/templates/prd-template.md`.
...
- Based on {pm-os}/templates/prd-template.md
...
**Reference the full template at `{pm-os}/templates/prd-template.md`.** Include only sections relevant to the current stage. Use this structure:
...
> Include for AI/ML features. Delete for non-AI features. See `{pm-os}/templates/prd-template.md` Section 3 for the full contract format.
